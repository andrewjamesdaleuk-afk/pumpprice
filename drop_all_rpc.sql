DROP FUNCTION IF EXISTS public.get_stations_along_route(geography, double precision, varchar);
DROP FUNCTION IF EXISTS public.get_stations_along_route(geography, double precision, text);
DROP FUNCTION IF EXISTS public.get_stations_along_route(geography, float, varchar);
DROP FUNCTION IF EXISTS public.get_stations_along_route(geography, float, text);
