...
BEGIN
    ...
    SELECT jsonb_agg(row_to_json(t)) INTO leaderboard_e10 FROM (SELECT * FROM get_brand_leaderboard('E10') LIMIT 10) t;
    SELECT jsonb_agg(row_to_json(t)) INTO leaderboard_b7 FROM (SELECT * FROM get_brand_leaderboard('B7') LIMIT 10) t;
    ...
    -- Wrap the cities queries properly
    ...
    VALUES 
        ...
        ('premium_gap_e10', 'premium_gap', 'E10', COALESCE(premium_gap_e10, '[]'::jsonb), NOW()),
        ('premium_gap_b7', 'premium_gap', 'B7', COALESCE(premium_gap_b7, '[]'::jsonb), NOW())
