...
BEGIN
    ...
    national_avgs AS (
        SELECT 
            ROUND(AVG(lp.price), 1)::NUMERIC as nat_petrol,
            ROUND(AVG(ld.price), 1)::NUMERIC as nat_diesel
        FROM stations s
    ...
    SELECT 
        ...
        ROUND(AVG(r.petrol_price), 1)::NUMERIC as petrolAvg,
        ROUND(AVG(r.diesel_price), 1)::NUMERIC as dieselAvg,
