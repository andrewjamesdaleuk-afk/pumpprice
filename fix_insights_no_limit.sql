...
BEGIN
    ...
    -- 1. Brand Leaderboard (REMOVE LIMIT 10)
    SELECT jsonb_agg(row_to_json(t)) INTO leaderboard_e10 FROM (SELECT * FROM get_brand_leaderboard('E10')) t;
    SELECT jsonb_agg(row_to_json(t)) INTO leaderboard_b7 FROM (SELECT * FROM get_brand_leaderboard('B7')) t;
