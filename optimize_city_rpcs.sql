-- 1. Optimized Cheapest Cities RPC
DROP FUNCTION IF EXISTS get_cheapest_cities(text);
CREATE OR REPLACE FUNCTION get_cheapest_cities(target_fuel_type TEXT)
RETURNS TABLE (
    city VARCHAR,
    price NUMERIC,
    diff NUMERIC
...
BEGIN
    ...
    ORDER BY ca.avg_price ASC
    LIMIT 4;
END;
$$ LANGUAGE plpgsql STABLE;

-- 2. Optimized Most Expensive Cities RPC
